...
<div class="form_control">
    ...
    <div id='prs_update_all_clients_button' class='button action'>Update All</div>
</div>
<div class="form_control">
    ...
    <div class="form_control">
        ...
        <div id='prs_search_for_client' class='button action'>Search</div>
    </div>
</div>
...
<nav class="nav-tab-wrapper">
    <a href="?page=prs_clients" class="nav-tab <?php if ($tab === null) : ?>nav-tab-active<?php endif; ?>">WP Users </a>
    <a href="?page=prs_clients&tab=resellers" class="nav-tab <?php if ($tab === 'resellers') : ?>nav-tab-active<?php endif; ?>">Resellers </a>
    <a href="?page=prs_clients&tab=all" class="nav-tab <?php if ($tab === 'all') : ?>nav-tab-active<?php endif; ?>">All </a>
</nav>
